...
[CreateAssetMenu(fileName = "MoveTowardPositionTarget", menuName = "SubAbilities/Movement/MoveTowardPositionTarget", order = 1)]
public class MoveTowardPositionTarget : SubAbility
{
