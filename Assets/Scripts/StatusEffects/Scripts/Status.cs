...
public abstract class Status : ScriptableObject
{
    ...
    [HideInInspector] public float endTime; //TODO: Make a method to set this or maybe even an interface. consider doing same for all hideininspector tags
    /// <summary>
    ...
    [HideInInspector] public List<StatusValue> statusValues = new List<StatusValue>();
